...
struct Proto_Reply {
  ...
  var error: Proto_Error {
    get {return _storage._error ?? Proto_Error()}
...
struct Proto_Publication {
  ...
  var gen: UInt32 {
    get {return _storage._gen}
    set {_uniqueStorage()._gen = newValue}
  }
  ...
  var info: Proto_ClientInfo {
    get {return _storage._info ?? Proto_ClientInfo()}
...
extension Proto_Reply: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _id: UInt32 = 0
    var _error: Proto_Error? = nil
    var _result: Data = SwiftProtobuf.Internal.emptyData
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 3: try decoder.decodeSingularBytesField(value: &_storage._result)
        default: break
        }
      }
    }
...
extension Proto_Publication: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _info: Proto_ClientInfo? = nil
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        switch fieldNumber {
        case 1: try decoder.decodeSingularUInt32Field(value: &_storage._seq)
        case 2: try decoder.decodeSingularUInt32Field(value: &_storage._gen)
        case 3: try decoder.decodeSingularStringField(value: &_storage._uid)
        case 4: try decoder.decodeSingularBytesField(value: &_storage._data)
        case 5: try decoder.decodeSingularMessageField(value: &_storage._info)
        default: break
        }
      }
    }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if _storage._gen != 0 {
        try visitor.visitSingularUInt32Field(value: _storage._gen, fieldNumber: 2)
      }
      if !_storage._uid.isEmpty {
        try visitor.visitSingularStringField(value: _storage._uid, fieldNumber: 3)
      }
  ...
  static func ==(lhs: Proto_Publication, rhs: Proto_Publication) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._gen != rhs_storage._gen {return false}
